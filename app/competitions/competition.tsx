...
export function Competition({ uuid }: CompetitionProps) {
    ...
    useEffect(() => {
        const fetchCompetition = async () => {
            ...
            try {
                const response = await fetch(`https://liveresults-master.local.nz/api/react/10/competitions/${uuid}`);
                ...
                setError(err instanceof Error ? err.message : 'An error occurred while fetching competition');
            } finally {
                setLoading(false);
            }
        };
